...
class OpenApiIntegrationTest {
    ...
    void apiDocsIncludesHalSchemasForHateoasResources() throws Exception {
        ...
        assertSchemaPresent(schemas, "UsuarioResourceDoc");
        assertSchemaPresent(schemas, "UsuarioCollectionDoc");
    ...
    void hateoasListAndGetResponsesReferenceHalSchemas() throws Exception {
        ...
        assertResponseSchemaRef(paths, "/api/usuarios", "get", "UsuarioCollectionDoc");
        assertResponseSchemaRef(paths, "/api/usuarios/{id}", "get", "UsuarioResourceDoc");
