...
class InventarioServiceImplTest {
    ...
    void registrarSalida_stockInsuficiente_lanzaInsufficientStockException() {
        ...
        com.minimarket.exception.InsufficientStockException exception = assertThrows(
                com.minimarket.exception.InsufficientStockException.class, () ->
                inventarioService.registrarSalida(1L, 5));

        assertEquals(0, exception.getDisponible());
