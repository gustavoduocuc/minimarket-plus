...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(CatalogoServiceUnavailableException.class)
    public ResponseEntity<Map<String, String>> handleCatalogoUnavailable(CatalogoServiceUnavailableException ex) {
        log.error("Catálogo-inventario no disponible: {}", ex.getMessage());
