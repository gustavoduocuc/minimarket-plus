...
class GlobalExceptionHandlerTest {
    ...
    @Test
    void handleCatalogoUnavailableReturns503Response() {
        CatalogoServiceUnavailableException exception =
                new CatalogoServiceUnavailableException("Catálogo-inventario no disponible al descontar stock");

        ResponseEntity<Map<String, String>> response = handler.handleCatalogoUnavailable(exception);
